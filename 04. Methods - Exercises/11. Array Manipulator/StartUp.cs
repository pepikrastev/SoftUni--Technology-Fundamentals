namespace _11._Array_Manipulator
{
    ...
    class StartUp
    {
        ...
        private static int[] GetLastCountEvenOrOddNumber(int[] array, int count, int devisionResult)
        {
            int[] arrResult = new int[count];
            int currentCount = 0;
            for (int i = array.Length - 1; i >= 0; i--)
            {
                if (array[i] % 2 == devisionResult && currentCount < count)
                {
        ...
        private static int[] GetFirstCountEvenOrOddNumber(int[] array, int count, int devisionResult)
        {
            int[] arrResult = new int[count];
            int currentCount = 0;
